...
This is now implemented in the main script, and will generate PDFs of within-population relatedness, but also will generate text file of pairs that are the most highly related (Ritland > 0.1).      
...
#### iii. Inbreeding coefficient per individual
